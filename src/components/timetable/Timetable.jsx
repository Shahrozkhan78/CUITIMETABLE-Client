...
const Timetable = () => {
  ...
  // ========================================================================c===
  /*"gi": These are flags for the regular expression:

g (global): This flag indicates that the regular expression should match all occurrences of the pattern in the input string, not just the first one.
i (case-insensitive): This flag indicates that the matching should be case-insensitive.*/
  ...
  const mondaytotal = FilterData.filter(
    (datavalues) =>
      datavalues.Day === "10000" ||
      datavalues.Day === "10001" ||
      datavalues.Day === "10010" ||
      datavalues.Day === "10100" ||
      datavalues.Day === "11000"
  ).length;
        ...
        <div>
          <div className="container  mt-3">
            <div className="row d-flex align-items-center jstify-content-between">
              <div className="col">
                <NavLink to="/">
                  {" "}
                  <button className="text-dark btn shadow-none">
          ...
          <div className="container mt-5">
            <Box className="m-0 p-0" sx={{ width: "100%" }}>
              ...
              <TabPanel
                className="p-0 d-flex align-items-centr justify-content-center"
                valuee={valuee}
                index={0}
              >
                {/*===========================Student Tab===================================  */}
                ...
                <div className="container  d-flex align-items-center justify-content-center ">
                  <div
                    className="row  d-flex  p-3    mb-5"
                    style={{ maxWidth: "650px" }}
                  >
                    {FilterData.filter(
                      (datavalues) =>
                        datavalues.Day === getD1 ||
                        datavalues.Day === getD2 ||
                        datavalues.Day === getD3 ||
                        datavalues.Day === getD4 ||
                        datavalues.Day === getDaydata
                    ).map((datavalues, id) => {
                      return (
                        <>
                          <div
                            className="col-12  columndiv  mt-2 mx-0 "
                            key={id}
                          >
                            <h3 className=" subject mt-3 ">
                              {datavalues.Subjects}
                            </h3>
                            <p className=" teacher mt-3">
                              {datavalues.Teacher}
                            </p>
                            <div
                              className="roombg bg-gray rounded "
                    ...
                    <div className="radio-toolbar-days text-center mb-2 mt-5 d-flex align-items-center justify-content-center">
                      ...
                      <div className="wednesday">
                        ...
                        <label for="wednesdaybutton" className="wednesday mb-0">
                          ...
                          <span className=" d-flex align-item-center justify-content-center">
                            <ul className="d-flex li ">
                              {[...Array(wednesdaytotalteacher)].map(
                                (elem, index) => (
                                  <li key={index}></li>
                                )
                              )}
                      ...
                      <div className="thursday">
                        ...
                        <label for="Thursdaybutton" className="thursday mb-0">
                          ...
                          <span className=" d-flex align-item-center justify-content-center">
                            <ul className="d-flex li ">
                              {[...Array(thursdaytotalteacher)].map(
                                (elem, index) => (
                                  <li key={index}></li>
                                )
                              )}
