...
const ProfileSettingManag = () => {
    const userid = localStorage.getItem("managloginuserid");
    ...
    const getdataValuesFun = async () => {
      const id=userid;
      const res = await fetch(baseurl+`/manag/login/usersdata/${id}`, {
        method: "GET",
        headers: {
  ...
  formData.append("imageurl",imageurl)
    ...
    axios
      .post(baseurl+ "/managment/update/signupusers", formData)
      .then((res) => {
    ...
    return (
      ...
      <div className='container mt-5 p-4 p-lg-5 d-felx align-items-start justify-content-center'>
       ...
       <div className=' d-flex flex-column align-items-center justify-content-center'> <Avatar alt={getname} src={File} sx={{ width: 150, height: 150 , fontSize:100}} /> </div>
        <div className='text-start mt-5'>
              <form>
                ...
                {/* <div className="mb-3">
                  ...
                  <input type="password" required className="form-control shadow-none" id="exampleInputPassword1" />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" value={getdepartment} onChange={(e)=>setdepartment(e.target.value)} required id="exampleFormControlInput1" placeholder="IT deaprtment" />
                </div>
                <div className="mb-3">
                  <p htmlFor="exampleFormControlInput1" className="form-label">Position</p>
                  <input type="text" required className="form-control" value={getposition} onChange={(e)=>setposition(e.target.value)} id="exampleFormControlInput1" placeholder="HOD" />
                </div>
