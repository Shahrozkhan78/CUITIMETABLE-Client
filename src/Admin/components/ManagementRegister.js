...
const ManagementRegister = () => {
    ...
    const [image, setimage] = useState("");
      ...
      const changeOnClick = (e) => {
        ...
        axios
          .post(baseurl+ "/managment/registerusers", formData)
          .then((res) => {
    ...
    return (
      ...
      <div className='container mt-5 p-4 p-lg-5 d-felx align-items-start justify-content-center'>
        <h3 classname="mb-5">Management Users &gt; New profile</h3>
        ...
        <div className='text-start mt-5'>
              <form>
                ...
                <div className="mb-3">
                  ...
                  <input type="number" className="form-control" required id="exampleFormControlInput1" value={getnumber} onChange={(e)=>setnumber(e.target.value)} placeholder="+92312345678" />
                </div>
                ...
                <button type="submit" className="btn btn-primary w-100" onClick={changeOnClick}>Add</button>
              </form>
