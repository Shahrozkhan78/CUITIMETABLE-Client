...
const Lectures = () => {
  ...
  const[getdaynamevalue,setdaynamevalue]=useState("")
  ...
  const getdate = () => {
    var today = new Date(),
      ...
      // alert(today.getDay())
      const daynameis=  day_name(today.getDay())
    
      setdaynamevalue(daynameis)
    setdate(date);
...
// ===========================================
const onSearhblock = (block) => {
  if(block==="lab"){
 
    const newdates= defaultdata.filter((obj)=>obj.Room.toLowerCase().substr(-3)==="lab"||obj.Room.toLowerCase().substr(-4)==="lab2"||obj.Room.toLowerCase().substr(-4)==="lab3"||obj.Room.toLowerCase().substr(-4)==="lab4"||obj.Room.toLowerCase().substr(-4)==="lab5" ).map(items=>items)
    ...
    const newdates= defaultdata.filter((obj)=>obj.Room.toLowerCase().substr(-3)!="lab"&&obj.Room.toLowerCase().substr(-4)!="lab1"&&obj.Room.toLowerCase().substr(-4)!="lab2"&&obj.Room.toLowerCase().substr(-4)!="lab3"&&obj.Room.toLowerCase().substr(-4)!="lab4"&&obj.Room.toLowerCase().substr(-4)!="lab5" ).map(items=>items)
    const blockname= newdates.filter((obj)=>obj.Room.toLowerCase().charAt(0)===block ).map(items=>items)
    setFilterData(blockname);
  }
  ...
  return (
    ...
    <div className="">
            <section className="searchsection w-100  mt-5  ">
              ...
              <div className="  pt-2 p-3 d-flex flex-column flex-lg-row align-top justify-content-between">
                ...
                {/* ==================================================== */}
                <div className="m-2 d-flex  w-100 flex-column align-items-center justify-content-between position-relative">
                  ...
                  <div
                    className="scrolldiv w-100 mt-0 suggtionw suggestion positon-absolute"
                ...
                <div className="m-2 d-flex w-100 flex-column align-items-center justify-content-between ">
                  ...
                  <div
                    className="scrolldiv w-100 mt-0 suggtionw suggestion"
              ...
              <div className="container">
                ...
                <select placeholder="Select Option " onChange={(e) => onSearhblock(e.target.value)} className="w-100  mb-xs-3 mb-lg-0 rounded-none" style={{ border: "1px solid gray" }}>
                  <option className="" selected disabled >
                    Select Block
                  </option>
      ...
      <h3 className="my-3 text-center">{getdaynamevalue}</h3>
      ...
      <section className=" mb-2 d-flex   complete-section">
        ...
        <div className="container  mb-5">
          <div className="row  d-flex row-cols-3 pt-2  align-items-center justify-content-center mb-5">
                  ...
                  <div className="col  columndiv" style={{width:"250px"}} key={id}>
                    ...
                    <div className="text-center mt-3 ">
                      ...
                      <div className="d-flex align-items-center">
                        <p className="icons m-0 p-0">
                          <BiTime  />
                        </p>
                        <p className="text-center lecture p-0 m-0 mt-2 ms-1 ">
            ...
            <button className="btn btn-primary rounded mb-5 w-50 mx-auto text-center"   onClick={showMore}>Load More</button>
