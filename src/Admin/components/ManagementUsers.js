...
const getdataValuesFun = async () => {
  ...
  const res = await fetch(baseurl+"/management/users", {
    method: "GET",
    headers: {
...
const deleteuser = async (id) => {
  ...
  const res2 = await fetch(baseurl+ `/management/delete/${id}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
...
// =======================================
  return (
    ...
    :
     ...
     <div className='d-flex align-items-center justify-content-between'><h3 classname="mb-4">Management User &gt; Profiles</h3>
     <button className='btn btn-success me-5'><Link to="/mangement/register" className=""><GroupAddIcon/></Link></button>
     </div> 
