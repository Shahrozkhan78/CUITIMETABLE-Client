  ...
  return (
    <>
      <Switch>
        ...
        <AdminProtectedRoute exact path="/admin/main" component={MainAdminpanel} />
        <AdminProtectedRoute exact path="/admin/about-us" component={MainAdminAboutus} />
        <AdminProtectedRoute exact path="/admin/director" component={MainAdminDirector} />
        <AdminProtectedRoute exact path="/admin/feedback" component={MainAdminFeedback} />
        <AdminProtectedRoute exact path="/admin/monitering_users_settings" component={MoniteringUsersSettings} />
        <AdminProtectedRoute exact path="/Admin/Addituser" component={Newituser} />
        <AdminProtectedRoute exact path="/Admin/Profilesetting" component={Profilesetting} />
        <AdminProtectedRoute exact path="/admin/register_new_user" component={AdminRegisterUserPage} />
        <AdminProtectedRoute exact path="/admin/admin_all_users" component={AdminAllUserPage} />
        <AdminProtectedRoute exact path="/mangement/register" component={ManagementRegisterUsers} />
        <AdminProtectedRoute exact path="/mangement/allusers" component={ManagementAllUsers} />
        <AdminProtectedRoute exact path="/admin/files_uploding" component={Fileuploadit} />
        <AdminProtectedRoute exact path="/admin/feedbacksection" component={FeedbackAdmin } />
        ...
        {/* =============================Visitor Routing=========================================== */}
        <ManagProtectedRoute exact path="/managment/report" component={Visitoradmin}/>
        <ManagProtectedRoute exact path="/managment/profilesetting" component={Profilesettingmang}/>
        <ManagProtectedRoute exact path="/managment/feedback" component={Feedbackmanag }/>
        <ManagProtectedRoute exact path="/management/dashboard" component={DashboardAdminV}/>
        {/* ==================================================================== */}
        <Route exact path="/monitering" component={MoniteringPage}></Route>
        <Route exact path="/visitor/login" component={MoniteringPageLogin}></Route>
        {/* ==========================Dashboard Admin========================================== */}
